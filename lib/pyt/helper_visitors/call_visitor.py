...
from lib.pyt.core.ast_helper import get_call_names_as_string
from lib.pyt.helper_visitors.right_hand_side_visitor import RHSVisitor


class CallVisitorResults(
    namedtuple(
        "CallVisitorResults", ("args", "kwargs", "unknown_args", "unknown_kwargs")
    )
):
    __slots__ = ()
